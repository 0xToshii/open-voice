...
class MainWindow(QMainWindow):
    ...
    def apply_styles(self):
        ...
        #providerCombo::down-arrow:hover {
        ...
        #providerCombo QAbstractItemView::item {
            padding: 10px 16px;
            border: none;
            color: #333333;
            font-weight: 500;
        ...
        #providerCombo QAbstractItemView::item:hover {
            background-color: #f5f5f5;
            color: #333333;
        }
        
        #providerCombo QAbstractItemView::item:selected {
            background-color: #e3f2fd;
            color: #1976d2;
            font-weight: 600;
        }
        
        #providerCombo QAbstractItemView::item:selected:hover {
            background-color: #e3f2fd;
            color: #1976d2;
        }
